...
class Analyzer:
    ...
    def analysis_behavior(self, selected_strategy):
        ...
        for open_time, close_time in trade_timestamp_list:
            ...
            assert len(timestamp_record) == len(timestamp_record)
            ...
            print()
            print("trade_position_record :  len = {}".format( len(trade_position_record)))
            print(trade_position_record)
            print()
            print("corresponding_market_information :  len = {}".format( len(corresponding_market_information)))
            print(corresponding_market_information)
            print()
            ...
            position_value_record = [
                ...
                for position, single_value in zip(
                    trade_position_record, corresponding_market_information['bid1_price'].values
                )
            ]
            total_value_record = [
                cash + position_value
...
if __name__ == "__main__":
    ...
    mean_return_rate, mean_duration, mean_mdd=analyzer.analysis_behavior(analyzer.strategy)
